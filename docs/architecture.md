...
- `apps/viewer` now delegates file-open/read/info, clipboard, polling file watching, and print behavior through `packages/platform`/`packages/converters`. It still owns viewer search state, rendered view composition, and Tauri adapter wiring.
