...
| Dedicated viewer-only E2E coverage was requested after the combined editor-led pass. | Fixed in follow-up. | Added `scripts/e2e-viewer-ui.mjs`, `pnpm test:e2e:viewer`, and `docs/audits/viewer-e2e-ui-audit-2026-06-24.md` with screenshots under `docs/audits/screenshots/e2e-viewer-ui/`. |
