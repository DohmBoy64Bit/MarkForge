...
- Superseded by Phase 11: current editor/viewer file watching uses native Tauri events through `packages/platform`, with polling retained as fallback behavior.
