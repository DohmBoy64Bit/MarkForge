...
- Selection-aware text transforms for inline formatting, headings, line prefixes, block wrappers, image insertion/update, table row/column edits, table alignment, line deletion, duplication, document formatting, and block insertion.
...
- Package-owned Markdown link/image path autocomplete trigger detection, workspace-entry filtering, and source replacement helpers.
