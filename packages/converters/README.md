...
DOCX, OCR, URL import, rich clipboard import, and full native PDF import/export are explicitly unsupported in Phase 7F; this package does not claim those capabilities.
